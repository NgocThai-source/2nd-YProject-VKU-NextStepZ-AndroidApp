...
export class EmailService {
  ...
  async sendChangePasswordOtpEmail(email: string, otp: string, fullName?: string): Promise<boolean> {
    try {
      const response = await this.resend.emails.send({
        from: this.fromEmail,
        to: email,
        subject: '🔐 Mã xác nhận thay đổi mật khẩu NextStepZ',
        html: this.generateChangePasswordOtpEmailTemplate(otp, fullName || 'Bạn'),
      });
  ...
  private generateChangePasswordOtpEmailTemplate(otp: string, userName: string): string {
    return `
      <!DOCTYPE html>
      <html>
        <head>
          ...
          <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .wrapper { padding: 20px 0; min-height: 100vh; }
            .container {
              max-width: 600px;
              margin: 0 auto;
              background: linear-gradient(135deg, #0f172a 0%, #1e3a8a 50%, #0c4a6e 100%);
            ...
            .logo { max-width: 360px; height: auto; margin: 0 auto 20px; display: block; }
            .header h1 { font-size: 32px; font-weight: 700; color: #ffffff; }
            .header p { font-size: 14px; color: rgba(255, 255, 255, 0.85); margin-top: 10px; }
            .content {
              padding: 50px 60px;
              background: linear-gradient(135deg, rgba(30, 58, 138, 0.8) 0%, rgba(12, 74, 110, 0.8) 100%);
            }
            .greeting { font-size: 20px; color: #ffffff; margin-bottom: 16px; font-weight: 600; }
            .greeting strong { color: #06b6d4; }
            .intro-text { font-size: 15px; color: rgba(255, 255, 255, 0.9); margin-bottom: 32px; line-height: 1.8; }
            .otp-section {
              background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%);
              border: 2px solid #06b6d4;
              border-radius: 16px;
            ...
            .otp-label { font-size: 12px; color: #0c4a6e; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 16px; font-weight: 700; }
            .otp-code { font-size: 56px; font-weight: 800; color: #0369a1; letter-spacing: 12px; font-family: 'Courier New', monospace; }
            .expiry-info { font-size: 13px; color: #0c4a6e; margin-top: 18px; font-weight: 600; }
            .security-info {
              background: linear-gradient(135deg, rgba(6, 182, 212, 0.15) 0%, rgba(8, 145, 178, 0.1) 100%);
              border-left: 4px solid #06b6d4;
              border-radius: 12px;
            ...
            .security-info strong { color: #06b6d4; }
            .info-text { font-size: 14px; color: rgba(255, 255, 255, 0.85); margin: 24px 0; }
            .info-text a { color: #06b6d4; text-decoration: none; font-weight: 700; }
            .footer {
              background: linear-gradient(135deg, rgba(15, 23, 42, 0.6) 0%, rgba(30, 58, 138, 0.6) 100%);
              padding: 30px 40px;
              text-align: center;
          ...
          <div class="wrapper">
            <div class="container">
              <div class="header">
                ...
                <p>Xác nhận yêu cầu thay đổi mật khẩu</p>
              </div>
              ...
              <div class="content">
                ...
                <p class="intro-text">
                  Bạn vừa yêu cầu thay đổi mật khẩu cho tài khoản NextStepZ từ trang Cài đặt. Để hoàn tất quy trình, vui lòng sử dụng mã xác thực bên dưới:
                </p>
                ...
                <div class="security-info">
                  <strong>🛡️ Lưu ý bảo mật:</strong> Không bao giờ chia sẻ mã này với bất kỳ ai. Đội ngũ NextStepZ sẽ không bao giờ yêu cầu bạn cung cấp mã này.
                </div>
                
                <p class="info-text">
                  ❓ Bạn không yêu cầu thay đổi mật khẩu? Vui lòng bỏ qua email này hoặc <a href="mailto:nguyenngocthai.nqu@gmail.com">liên hệ với chúng tôi ngay</a> nếu bạn có bất kỳ nghi ngờ nào.
                </p>
              </div>
