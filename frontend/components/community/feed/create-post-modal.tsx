...
import { X, Plus, Upload, AlertCircle, Image as ImageIcon, Loader2 } from 'lucide-react';
...
export function CreatePostModal({
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setImageFiles([...imageFiles, ...newFiles]); // Store actual File objects
  };
    ...
    try {
      ...
      if (imageFiles.length > 0) {
        ...
        if (!uploadResponse.ok) {
          ...
          setErrors([error.message || 'Không thể tải ảnh lên']);
      ...
      // Call API to create post with uploaded image URLs
