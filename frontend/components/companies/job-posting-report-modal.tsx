...
interface JobPostingReportModalProps {
    isOpen: boolean;
...
const reportReasons = [
    ...
    { id: 'fake', label: 'Thông tin tuyển dụng giả mạo' },
    { id: 'misleading', label: 'Thông tin sai lệch về công ty/mức lương' },
    { id: 'scam', label: 'Lừa đảo hoặc thu phí bất hợp pháp' },
    { id: 'inappropriate', label: 'Nội dung không phù hợp' },
    { id: 'discrimination', label: 'Phân biệt đối xử' },
    { id: 'other', label: 'Khác' },
];

export function JobPostingReportModal({
    isOpen,
    posting,
    onClose,
    onSubmit,
}: JobPostingReportModalProps) {
    ...
    const handleSubmit = async () => {
        if (!selectedReason || !posting) return;
    ...
    if (!posting || !mounted) return null;
                                ...
                                {submitted ? (
                                    ...
                                    <>
                                        ...
                                        <div className="p-4 rounded-lg bg-white/5 border border-cyan-400/10">
                                            ...
                                            <p className="text-xs text-gray-400 line-clamp-2">{posting.description}</p>
                                        </div>
